...
-- Reference copy from baza źródłowa (dbo.waluta) (populated before migration run)
...
-- Reference copy from baza źródłowa (dbo.kurs_walut) (populated before migration run)
...
-- Reference copy from baza źródłowa (dbo.ksiegowanie_konto_subkonto) (populated before migration run)
...
-- Reference copy from baza źródłowa (dbo.dokument_odsetki_przerwy_typ) (populated before migration run)
...
-- system_admin_user_id: ID of the system user in baza źródłowa (dbo.GE_USER)
...
-- ============================================================
-- log.check_toggle seed (KPI only — 43 entries)
-- VALIDATION (non-KPI) toggles seeded by 00_seed_check_toggle.sql
-- generated from @bakk/validation-rules (Phase 1B-B).
-- ============================================================
