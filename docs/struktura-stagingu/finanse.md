...
<ul class="param-list">
  ...
  <li>
    ...
    <span class="param-type">INT</span>
    <span class="param-desc">FK do księgowania - kopiowany wprost (prod ks_id = staging ks_id po Section 1)</span>
  </li>
  <li>
